...
\def\titleEN{End-to-End Traffic Data Pipeline for Ho Chi Minh City: Acquisition, Persistence and Analytical Insights}
...
\mainmatter
\setlength{\parskip}{0.7em}
% Transportation Data Platform Report
\input{text/1-Introduction}
\input{text/3-DataCrawlingPipeline}
\input{text/4-DatabaseManagement}
\input{text/5-DataProcessingAnalytics}
\input{text/6-DataIntegration}
\input{text/7-EDA_UnstructuredData}
