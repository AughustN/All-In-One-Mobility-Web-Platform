...
const OAuthButtons = ({ onGoogleLogin, onGithubLogin }) => {
  return (
    <div style={{ marginTop: '1.5rem' }}>
      ...
      <div style={{ 
        ...
        <span style={{ color: '#71717a', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          Hoặc
        </span>
        <div style={{ flex: 1, height: '1px', background: '#27272a' }}></div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '0.75rem' }}>
        ...
        <button
          type="button"
          onClick={() => onGithubLogin && onGithubLogin()}
