...
\def\titleEN{Ho Chi Minh City Traffic Camera \& Route Finder}
...
\input{text/3-Backend}
\input{text/4-Interaction}
\input{text/5-Readiness}
\input{text/6-Deployment}
\input{text/7-Performance}
\input{text/8-Security}
