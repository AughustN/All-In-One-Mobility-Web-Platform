...
# ---------------------------------------------------------
def match_image_in_general(item):
    category = item.get("root_category", "landmarks").lower()
    img_type = item.get("image_type", "general").lower()
    specific_path = f"images/general/{category}/{img_type}/cover.jpg"
    fallback_path = f"images/general/{category}/general/cover.jpg"
    if os.path.exists(specific_path):
        return specific_path
    elif os.path.exists(fallback_path):
        return fallback_path
    else:
        return f"images/general/cover.jpg"